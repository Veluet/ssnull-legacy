...
$resolutions   = array(1024, 940, 640, 480, 360); // the resolution break-points to use (screen widths, in pixels)
$cache_path    = "image-cache"; // where to store the generated re-sized images. Specify from your document root!
